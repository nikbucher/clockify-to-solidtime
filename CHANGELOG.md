...
- `completions` command for generating shell completions for Bash, Zsh, Fish, PowerShell, and Elvish
- Homebrew formula update workflow after releases complete

### Changed

- Updated GitHub Actions and Rust dependencies
